...
export function AboutSection({ profile }: { profile : Profile }) {
 ...
 // Datos estáticos de trayectoria profesional
  ...
  // Datos de educación
  const startDateEducation = profile.relationships.field_education.data.attributes?.field_start_date;
  const endDateEducation = profile.relationships.field_education.data.attributes?.field_start_date;
